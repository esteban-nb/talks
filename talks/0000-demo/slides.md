...
- Element 1 (full at step 0) <!-- .element: class="fragment custom activate" data-fragment-index="0" -->
- Element 2 (full at step 1) <!-- .element: class="fragment custom activate" data-fragment-index="1" -->
- Element 3 (full at step 0 & 2) <!-- .element: class="fragment custom activate" data-fragment-index="0,2" -->
