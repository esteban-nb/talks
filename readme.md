...
Check [Markdown](https://revealjs.com/markdown/) integration in Reveal.js (plus [demo](https://revealjs.com/demo/) of features such as fragments, auto-animate, image/video/iframe backgrounds, speaker view).
